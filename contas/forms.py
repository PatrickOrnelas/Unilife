...
class RegistroPersonalForm(forms.Form):
    ...
    sex        = forms.ChoiceField(label="Sexo", choices=[("M","Masculino"), ("F","Feminino"), ("O","Outro")])
    date_of_birth = forms.DateField(label="Data de nascimento", widget=forms.DateInput(attrs={"type": "date"}))
    cref       = forms.CharField(label="CREF", max_length=20, required=False)
    # Campos de senha removidos - senha será gerada automaticamente
    ...
    def save(self):
        ...
        # Gerar senha automaticamente: Primeiro nome capitalizado + 123
        senha_gerada = first_name.capitalize() + "123"
