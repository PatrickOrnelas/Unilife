...
class Aluno(models.Model):
    ...
    rua = models.CharField(max_length=254, blank=True, default="")
    numero = models.CharField(max_length=20, blank=True, default="")
    bairro = models.CharField(max_length=120, blank=True, default="")
    cep = models.CharField(max_length=8, blank=True, default="")  # apenas dígitos
...
class Personal(models.Model):
    ...
    email = models.EmailField()
    date_of_birth = models.DateField()
    cref = models.CharField(max_length=20, blank=True, null=True)
    ativo = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True, db_index=True)
    updated_at = models.DateTimeField(auto_now=True)
