...
class PerfilBase(TimeStampedModel):
    ...
    def __str__(self):
        # username = CPF (só dígitos), mas exibimos formatado
...
class Personal(PerfilBase):
    cref = models.CharField(max_length=20, unique=True)  # deixe único para garantir integridade
...
class Anamnese(models.Model):
    ...
    responsavel = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="anamneses_realizadas")
